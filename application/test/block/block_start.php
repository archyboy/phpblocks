...
class Block_Start extends \System\Block {
    ...
    public function __construct() {
      ...
      \System\Block::set_brick(\System\Application::$config);
      \System\Block::set_brick(\System\Application::$debug);
      \System\Block::set_brick(\System\Application::$builder);

      $new_bricks[] = \System\Block::get_brick('System\Debug');

      \System\Helper::print_pre($new_bricks);
      \System\Helper::print_pre(\System\Application::$bricks);

      $this->init();
    }

    public function init() {
      $this->view = new \System\View(\System\Application::$config->get('TEMPLATE_ACTIVE_DIRECTORY') . 't_start.php');
